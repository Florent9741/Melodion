...
<div class="min-h-screen flex items-center justify-center bg-blue-100 py-12 px-4 sm:px-6 lg:px-8">
  ...
  @endif
    ...
    <div class="text-3xl text-left font-bold text-green-600 mt-20 mb-10">
     ...
     @endif
        <img class="mx-auto h-12 w-auto rounded-full" src="https://picsum.photos/200" alt="Workflow">
  ...
  <footer class="text-gray-600 body-font">
    <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
      <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        ...
        <span class="ml-3 text-xl">melodion</span>
      </a>
      <p class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2021 melodion —
