    ...
    <div class="container mt-4">
        ...
        <div class="row">
            @foreach ($videos as $video)
                <div class="col-4 ">
                    <a href="{{ route('watch', $video->videoId) }}" class="href">
                        <div class="flex items-stretch mb-4 card">
            ...
            <form class="block text-right" action="{{route('likes')}}" method="POST">
                ...
                <div class="inline-block p-0 m-0 text-right duration-300 ease-in-out hover:text-sky-700"><button type="submit" name="like" value="1"><i class="fa-solid fa-thumbs-up"></i>{{$like->count}}</button></div>
                @endif
              </form>
